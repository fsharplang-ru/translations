...
Этот пост не о том, как "перевести" код с C# на F#: различные парадигмы делают каждый из этих языков лучшим для своего круга задач. Однако мы считаем, что изучение понятий функционального программирования расширит ваш кругозор и поможет вам программировать лучше. Вы оцените все достоинства функционального программирования быстрее, если не будете думать о переводе кода из одной парадигмы в другую.
