...
Неизменяемость делает больше, чем просто меняет способ управления данными в списках. Понятие ссылочной прозрачности ((Referential Transparency)[http://wiki.c2.com/?ReferentialTransparency]) естественным образом возникает в F#, и это ???, как системы разрабатываются и как части этих систем сочетаются. Функциональные характеристики системы становятся более предсказумыми из-за того, что значения не изменяются, когда вы этого не ожидаете.
